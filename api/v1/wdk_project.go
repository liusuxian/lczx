...
type WdkProjectListReq struct {
	...
	Name             string      `json:"name" dc:"项目名称"`                                                                                                                                                                 // 项目名称
	...
	BusinessForms    []uint      `json:"businessForms" v:"slice_valid:uint#业态ID列表不能为空" dc:"业态 0:住宅 1:小高层 2:高层 3:超高层 4:公寓 5:合院 6:叠墅 7:排屋 8:多层 9:会所 10:商住 11:综合体 12:产业园 13:酒店 14:酒店式公寓 15:商业 16:普通商业 17:公共配套 18:办公 19:厂房"` // 业态 0:住宅 1:小高层 2:高层 3:超高层 4:公寓 5:合院 6:叠墅 7:排屋 8:多层 9:会所 10:商住 11:综合体 12:产业园 13:酒店 14:酒店式公寓 15:商业 16:普通商业 17:公共配套 18:办公 19:厂房
	ContractStatus   string      `json:"contractStatus" v:"in:0,1#签约状态只能是0,1" dc:"签约状态 0:新签 1:续签"`                                                                                                                       // 签约状态 0:新签 1:续签
	ContractSum      string      `json:"contractSum" v:"regex:^\\d*\\.*\\d*$#合同金额必须大于0" dc:"合同金额"`                                                                                                                       // 合同金额
	DeepCulture      string      `json:"deepCulture" v:"in:0,1#是否为深耕只能是0,1" dc:"是否为深耕 0:否 1:是"`                                                                                                                          // 是否为深耕 0:否 1:是
	Status           string      `json:"status" v:"in:0,1,2,3,4#服务状态只能是0,1,2,3,4" dc:"服务状态 0:服务中 1:暂停 2:提前终止 3:跟踪期 4:洽谈中"`                                                                                               // 服务状态 0:服务中 1:暂停 2:提前终止 3:跟踪期 4:洽谈中
...
type WdkProjectAddReq struct {
	...
	Name           string      `json:"name" v:"required#项目名称不能为空" dc:"项目名称"`                                                                                                                                                           // 项目名称
	...
	ContractSum    float64     `json:"contractSum" v:"required|regex:^([1-9]+\\d*)(\\.\\d+)?$#合同金额不能为空|合同金额必须大于0" dc:"合同金额"`                                                                                                           // 合同金额
	DeepCulture    uint        `json:"deepCulture" v:"required|in:0,1#是否为深耕不能为空|是否为深耕只能是0,1" dc:"是否为深耕 0:否 1:是"`                                                                                                                       // 是否为深耕 0:否 1:是
	Status         uint        `json:"status" v:"required|in:0,1,2,3,4#服务状态不能为空|服务状态只能是0,1,2,3,4" dc:"服务状态 0:服务中 1:暂停 2:提前终止 3:跟踪期 4:洽谈中"`                                                                                             // 服务状态 0:服务中 1:暂停 2:提前终止 3:跟踪期 4:洽谈中
