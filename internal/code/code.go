...
var (
	...
	GetUserListFailed = gcode.New(1001, "获取用户列表失败", "") // 获取用户列表失败
	AddUserFailed     = gcode.New(1002, "新增用户信息失败", "") // 新增用户信息失败
	DeleteUserFailed  = gcode.New(1003, "删除用户信息失败", "") // 删除用户信息失败
	UpdateUserFailed  = gcode.New(1004, "修改用户信息失败", "") // 修改用户信息失败
