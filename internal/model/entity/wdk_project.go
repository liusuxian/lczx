...
type WdkProject struct {
	...
	Status             uint        `json:"status"             description:"服务状态 0:服务中 1:暂停 2:提前终止 3:跟踪期 4:洽谈中 5:正常结束"`                                                                                         // 服务状态 0:服务中 1:暂停 2:提前终止 3:跟踪期 4:洽谈中 5:正常结束
	...
	FileUploadLastTime *gtime.Time `json:"fileUploadLastTime" description:"项目文件最近一次上传时间"`                                                                                                                      // 项目文件最近一次上传时间
	CreatedAt          *gtime.Time `json:"createdAt"          description:"项目创建时间"`                                                                                                                            // 项目创建时间
	UpdatedAt          *gtime.Time `json:"updatedAt"          description:"项目更新时间"`                                                                                                                            // 项目更新时间
