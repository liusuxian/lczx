...
// Delete 删除文档库服务记录
func (c *cWdkService) Delete(ctx context.Context, req *v1.WdkServiceRecordDeleteReq) (res *v1.WdkServiceRecordDeleteRes, err error) {
	err = service.WdkService().DeleteWdkServiceRecord(ctx, req.Ids)
	if err != nil {
